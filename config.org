  ...
  (use-package mu4e
    ...
    (mu4e-maildir-shortcuts
                  '(("/Inbox"             . ?i)
                    ...
                    ("/Gmail/Personal/[Gmail]/All Mail"  . ?a)))
    (mu4e-contexts
     (list
      ;; Personal account
      (make-mu4e-context
       ...
       :vars '((user-mail-address . "qkessler@gmail.com")
               ...
               (mu4e-bookmarks . '(
                                  ("maildir:/Gmail/Personal/Inbox" "Inbox" ?i)
                                  ("flag:unread AND to:qkessler@gmail.com" "Unread messages" ?u)
                                  ("date:today..now AND to:qkessler@gmail.com" "Today's messages" ?t)
                                  ("date:7d..now AND to:qkessler@gmail.com" "Last 7 days" ?w)))))
      (make-mu4e-context
       :name "Work"
       :match-func
       (lambda (msg)
       ...
       :vars '((user-mail-address . "enrique.kesslerm@gmail.com")
               ...
               (mu4e-bookmarks . '(
                              ("maildir:/Gmail/Work/Inbox" "Inbox" ?i)
                              ("flag:unread AND to:enrique.kesslerm@gmail.com" "Unread messages" ?u)
                              ("date:today..now AND to:enrique.kesslerm@gmail.com" "Today's messages" ?t)
                              ("date:7d..now AND to:enrique.kesslerm@gmail.com" "Last 7 days" ?w)))))
      (make-mu4e-context
       :name "UMU"
       :match-func
       (lambda (msg)
       ...
       :vars '((user-mail-address . "enrique.kesslerm@um.es")
               ...
               (mu4e-refile-folder  . "/UMU/All Mail")
               (mu4e-trash-folder  . "/UMU/Trash")
               (mu4e-bookmarks . '(
                             ("maildir:/UMU/Inbox" "Inbox" ?i)
                             ("flag:unread AND to:enrique.kesslerm@um.es" "Unread messages" ?u)
                             ("date:today..now AND to:enrique.kesslerm@um.es" "Today's messages" ?t)
                             ("date:7d..now AND to:enrique.kesslerm@um.es" "Last 7 days" ?w)))))))
    :config (mu4e t))
#+end_src
