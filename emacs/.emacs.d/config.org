...
*** PlantUML
    ...
    There have been multiple modes defined for Emacs editing of puml files, having the last one being the default: =plantuml-mode=.
    #+begin_src emacs-lisp
...
**** Mu4e
     ...
     #+begin_src emacs-lisp
       (use-package mu4e
         ...
         (straight-use-package 'mu4e-context)
         (setq mu4e-contexts
               (list
                ;; Work account
                (make-mu4e-context
