...
#+begin_src emacs-lisp :tangle no
  ...
  (use-package mu4e
    ...
    (mu4e-maildir-shortcuts
     '( (:maildir "/Gmail/Personal/[Gmail]/All Mail"     :key  ?p)
        (:maildir "/Gmail/Work/[Gmail]/All Mail"   :key  ?w)
        (:maildir "/UMU/Inbox"     :key  ?u)))
    (mu4e-contexts
     (list
      ;; Personal account
      (make-mu4e-context
...
#+begin_src emacs-lisp
  ...
  :hook (elfeed-search-mode-hook-hook . prot-elfeed-load-feeds)
