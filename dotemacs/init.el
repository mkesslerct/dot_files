...
(custom-set-variables
 ...
 '(package-selected-packages
   '(org-protocol oauth2 org-caldav yaml-mode toc-org xref-js2 json-mode tide elfeed-dashboard hungry-delete bufler monokai-theme gruvbox-theme hover lsp-java lsp-dart ccls lsp-treemacs lsp-ivy flycheck lsp-ui lsp-mode yasnippet-snippets smart-comment projectile web-mode magit emmet-mode doom-modeline autopair all-the-icons auto-package-update rainbow-mode subatomic-theme use-package))
